...
if (isset($_SESSION['firstname']) && isset($_SESSION['email'])) {
    ...
    if (isset($_POST['btnPost'])) {
        ...
        $price = $_POST['price']; // Retrieve price data from form
        ...
        $insert = "INSERT INTO food(food_id, food_name, author, prep_time, cook_time, servings, price, proced, nutri_info, likes) 
                VALUES ('$fID','$recName' ,'$email', '$timePrep', '$timeCook', '$serveSize', '$price', '$procedure', '$nutriValue', '0')";
                        ...
                        <div class="row" id="sec3">
                            <div class="col text-center" id="formcol">
                                ...
                                <form method="POST" action="feed.php" id="recp-form">
                                    ...
                                    <div class="form-group">
                                        <label for="price"><span class="formlabel">Price:</span></label>
                                        <textarea class="form-control" rows="1" name="price" id="price" required></textarea>
                                    </div>
            ...
            $("#postbtn").click(function() {
                ...
                $("sayo.ingrds").each(function() {
                    ...
                    if (ingData.length > 0 && amtData.length > 0) {
                        ingData.each(function() {
                            ingredients.push($(this).text());
                        });
                        amtData.each(function() {
